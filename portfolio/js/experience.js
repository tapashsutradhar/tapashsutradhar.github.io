...
//  {shortName:"InnoByte Services",role:"Data & Business Analyst",type:"Internship",start:"Feb 2024",end:"May 2024",current:false,location:"New Delhi, India",domain:"Business Intelligence · Reporting",achievements:["Analysed complex datasets with Python and SQL, improving reporting efficiency by 25%.","Built automated Tableau dashboards converting raw business metrics into actionable insights."],tech:["Python","SQL","Tableau","Business Intelligence"]},
  {shortName:"Seap Infotech",role:"Software Developer & QA Engineer",type:"Full-time",start:"Sept 2025",end:"Present",current:true,location:"Kolkata, India",domain:"SaaS · Asset Management · USA Public Clients",achievements:["Executed end-to-end API validation and cross-platform mobile testing (Android/iOS), expanding test coverage by 40% for international client modules.","Designed and deployed core modules for a scalable SaaS Asset Management platform using C#, .NET, and SQL Server.","Developed RESTful APIs and Google Maps API integration for geospatial asset tracking.","Led Manual Testing cycles (Functional, UAT, Smoke) with zero defect leakage to production.","Built a Playwright + Java hybrid automation framework, cutting regression testing time by 60%."],tech:["C#",".NET","SQL Server","Playwright","Java","Postman","Jira","API"]},
  {shortName:"WBSETCL",role:"Data & Analytics Analyst",type:"Full-time",start:"Jan 2024",end:"Aug 2025",current:false,location:"Kolkata, India",domain:"Power Grid · Demand Forecasting · ML",achievements:["Developed ML forecasting solutions for electricity demand, improving accuracy by 20–25%.","Automated data cleaning and transformation workflows in Python and SQL, improving reliability by 30%.","Built Power BI dashboards for grid performance, reducing manual reporting time by 15 hrs/week.","Deployed anomaly detection models for proactive operational decisions."],tech:["Python","Pandas","SQL","Power BI","Machine Learning","Excel"]},
  {shortName:"Zidio Development",role:"Software Development Engineer",type:"Internship",start:"Aug 2023",end:"Jan 2024",current:false,location:"Bengaluru, India",domain:"MERN Stack · Full-Stack",achievements:["Built MERN stack features end-to-end, implementing RESTful APIs.","Integrated unit tests ensuring 95% code reliability across core modules.","Analysed complex datasets with Python and SQL, improving reporting efficiency by 25%.","Built automated Tableau dashboards converting raw business metrics into actionable insights."],tech:["MongoDB","Express","React","Node.js","REST APIs","JavaScript","HTML","CSS","Python","SQL","Tableau"]},
];
